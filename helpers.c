...
void edges(int height, int width, RGBTRIPLE image[height][width])
{
    ...
    for(int i = 0; i < height ; i++)
    {
        for(int j = 0; j < width ; j++)
        {
            ...
            finalred = (int) round(redsumgx * redsumgx) + (redsumgy * redsumgy);
            finalgreen = (int) round(greensumgx * greensumgx) + (greensumgy * greensumgy);
            finalblue = (int) round(bluesumgx * bluesumgx) + (bluesumgy * bluesumgy);
