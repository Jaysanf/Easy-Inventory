...
bool cyclecheck(int winner, int loser, int j)
{
    ...
    for (int i = j; i >= 0; i--)
    {
        ...
        //Checks if we can simplify with loser and another winner; ex; C-B and A-C to A-B AND that we simplify with something that has already been locked
        ...
        //Checks if we can simplify with winner and another loser; ex; B-C and C-A to B-A AND that we simplify with something that has already been locked
